  ...
  return (
    <section id="anchor-projects">
      ...
      <ProductCardOther
        ...
        description="Ниже таблица во всех проектах и сферах. Также есть опыт в разработки большого числа проектов, информация о которых не может быть разглашена полностью политиками NDA, либо эти продукты находятся на стадии разработки, либой в которых мой вклад был косметическим."
      // summaryItems={[
