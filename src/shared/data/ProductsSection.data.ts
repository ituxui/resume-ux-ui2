...
export const productsMap: Record<ProjectKey, ProjectData> = {
  ...
  'case-tsd': {
    ...
    meta: [
      ...
      { title: 'Скорость обслуживания клиентов', value: 'в 2 раза' },
      { title: 'Ошибок', value: '-80%' },
      { title: 'Количество вопросов от сотрудников за месяц', value: 'с 10 до ~1' },
    ],
    screens: [
